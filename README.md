...
не нужно. Ручная проверка — меню **Справка → Проверить обновления** или одноимённая
кнопка на панели инструментов. Автопроверку при старте можно отключить настройкой
...
- `app/window.py` содержит главное окно: меню, toolbar, дерево wiki, режимы просмотра/правки, историю, трей.
